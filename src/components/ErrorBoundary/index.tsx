...
const IS_DANDELION_LABS = window.location.hostname.includes('dandelionlabs.io')
                ...
                <AutoRow>
                  <LinkWrapper>
                    <ExternalLink
                      ...
                      href={`https://github.com/dandelionlabs-io/web3-template/issues/new?assignees=&labels=bug&body=${encodedBody}&title=${encodeURIComponent(
                  ...
                  <LinkWrapper>
                    <ExternalLink id="get-support-via-mail" href="mailto:hello@dandelionlabs.io" target="_blank">
                      <ThemedText.Link fontSize={16}>
